...
export class ColumnColorsComponent {
  ...
  @Input('columnIndex') columnIndex: number = 0;
  @Input('colorText') colorText: string = '#a1619c';
  @Output('emitColor') emitColor = new EventEmitter<any>();
  ...
  changeColor(evt: any, i: any) {
    let c: any=  {color: evt, column: this.columnIndex, line: i}
    this.emitColor.emit(c)
    console.log('📢[column-colors.component.ts:21]: evt: ', evt, i);
  }
}
